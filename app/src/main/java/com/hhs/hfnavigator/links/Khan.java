...
public class Khan extends Activity{

	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.khan);
	}
	//_______________PRE LABS_____________________________________________________________________________
 	public void k1 (View view) {
        goToUrl ("https://sites.google.com/site/khangoesape/");}
 	public void k2 (View view) {
        goToUrl ("https://sites.google.com/site/khanteachesrocks");}
    public void k3 (View view) {
        goToUrl ("http://wps.pearsoncustom.com/wps/media/objects/4384/4489994/ebk/htm/_we2.htm");}
